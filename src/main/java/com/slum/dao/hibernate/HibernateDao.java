package com.slum.dao.hibernate;

import com.slum.dao.exception.Cm4jDataAccessException;
 ...
 * -----------------------------------------------------------
 * <p>
 * <b><font color="red">DAO实现类已通过Autowired方式注入{@link org.hibernate.SessionFactory}</font></b>
 * <p>
 * <b><font color="red">DAO实现类可通过this.getHibernateTemplate()获得
 * {@link org.springframework.orm.hibernate3.HibernateTemplate}对象</font></b>
 * <p>
 * -----------------------------------------------------------
 * <p>
 * <b>注入方式：<font
